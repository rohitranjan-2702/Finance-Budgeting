...
const Footer = () => {
  ...
  <div class="mx-auto px-16 py-20">
    ...
    <div class="mt-8 grid w-full grid-cols-1 gap-8 sm:grid-cols-3">
      ...
      <div class="flex items-center justify-center">
        <p class="text-sm leading-4 text-white">&copy; 2023 FinanceAPP All Rights Reserved.</p>
      </div>
      <div class="flex items-center justify-center">
        <ul class="flex items-center justify-center gap-x-4">
          <li class="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300">
