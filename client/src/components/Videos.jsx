...
<aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul class="space-y-2">
         ...
         <li>
            <a href="/videos" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
...
<p class="text-gray-900 text-7xl font-bold dark:text-white flex justify-center mb-20 ">Videos</p>
   <div class="p-4  rounded-lg dark:border-gray-700">
      ...
      <div class="grid grid-cols-2 gap-4 mb-3">
         ...
         <video class="w-full h-auto max-w-xl border border-gray-200 rounded-lg dark:border-gray-700" controls>
          <source src="https://youtu.be/Xn7KWR9EOGQ" type="video/mp4"/>
