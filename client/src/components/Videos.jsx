...
<aside id="default-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
   <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
      <ul className="space-y-2">
         ...
         <li>
            <a href="/videos" className="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
...
<p className="text-gray-900 text-7xl font-bold dark:text-white flex justify-center mb-20 ">Videos</p>
   <div className="p-4  rounded-lg dark:border-gray-700">
      ...
      <div className="grid grid-cols-2 gap-4 mb-3">
         ...
         <video className="w-full h-auto max-w-xl border border-gray-200 rounded-lg dark:border-gray-700" controls>
