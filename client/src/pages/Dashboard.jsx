    ...
    <>
      ...
      <div className="m-4 flex max-w-full flex-col items-center justify-center rounded-md bg-slate-200 p-5">
        <div className="mb-4 text-3xl">
          Income: <span className="font-bold text-purple-700">$10,000</span>
        </div>
        <div className="mb-4 text-3xl">
          Expenses: <span className="font-bold text-purple-700">$7000</span>
        </div>
        <div className="mb-4 text-3xl">
          Savings: <span className="font-bold text-purple-700">$3000</span>
        </div>
